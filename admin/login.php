...
<body class="login">
	<div class="wrapper wrapper-login" >
		...
		<img src="assets/img/pi.png" ></td><td style="padding-top:8px;"><!-- <h1 style="font-family:Montserrat;">&nbsp;SCORE SLMRS</h1>  -->
	</td></tr></table> 
	...
	<form action="code.php" method="POST">
	    	<div class="login-form">
				...
				<div class="form-action mb-3">
					<button type="submit" name="loginbtn" class="btn btn-primary btn-rounded btn-login" style="padding:10px 5px 10px 5px;">Login</button>
				</div>
					</form>
				  <?php
                     
                     if(isset($_SESSION['status1']) && $_SESSION['status1'] !=''){
                      echo '<p class="text-danger" align="center"> '.$_SESSION['status1']. '</p>';
