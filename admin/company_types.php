						...
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Company Types&nbsp;&nbsp;<button style="padding: 5px 15px 5px 15px;" type="button" class="btn btn-primary btn-round " data-toggle="modal" data-target="#addadminprofile">Add Company Type</button></div>
								</div>  
								<div class="card-body">
...
<div class="table-responsive">
                    <table width="50%" align="left" id="example" class="table table-bordered table-hover" >
                        ...
                        <tbody>
                    <?php
                    $query= mysqli_query($con, "SELECT * FROM company_type");
                    ...
                    <tr>
                    <td style="width:10%;" class="number1" data-id1="<?php echo $row['type_id']; ?>" contenteditable><?php echo $row['number']; ?></td>
                    <td class="number2" data-id2="<?php echo $row['type_id']; ?>" contenteditable><?php echo $row['type']; ?></td>

                       
<td >
<button type="button" style="padding: 5px 10px 5px 10px;" data-id3="<?php echo $row['type_id']; ?>" id="deletetype" class="btn btn-danger"><i class="fa fa-trash-alt"></i></button>
...
<label>Type </label>
    <input type="text" name="type" id="display" class="form-control" placeholder="Enter Company Type" required>
</div>
...
<button type="submit" name="inserttype" id="inserttype" class="btn btn-primary">Save</button>
</div>
</form>
            ...
            $.ajax({  
                    ...
                    dataType:"text",
                     success:function(data1){  
                       if (data1=="Company Type already exists") {
                            var btn = document.querySelector('#inserttype');
        btn.disabled=true;
