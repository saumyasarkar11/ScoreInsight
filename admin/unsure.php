						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">New Prospects</div>
								</div>  
								<div class="card-body">
									...
									<div class="table-responsive">
                                       ...
                                       <tr>
                                           <th style="font-weight:bolder;">ID</th>
                                            ...
                                            <th style="font-weight:bolder;">Prospect (Rs.)*</th>
                                ...
                                <tr>
                                    ...
                                    <td data-toggle="tooltip" data-placement="bottom" title="<?php $n=rtrim($row['requirement'], ", "); echo $n; ?>"><?php echo "Rs.".$row['prospect_value'].""; ?></td>
                                    ...
                                    <?php
                                     ...
                                     ?>
                                    <td data-toggle="tooltip" data-placement="bottom" title="Designation: <?php echo $row_v['name']; ?>, Email: <?php echo $row_x['email']; ?>, Under: <?php echo $row_x['head']; ?>  ">
