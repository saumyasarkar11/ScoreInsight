							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Branches&nbsp;&nbsp;
									  <?php
               $query= mysqli_query($con, "SELECT * FROM designation WHERE level != 'L1'");
                    if (mysqli_num_rows($query)<5){
            ?>
                	<button style="padding: 5px 15px 5px 15px;" type="button" class="btn btn-primary btn-round " data-toggle="modal" data-target="#addadminprofile">Add Branch</button>
                <?php
                    } else {
...
<div class="table-responsive">
                    ...
                    <td class="number2" data-id2="<?php echo $row['designation_id']; ?>" contenteditable><?php echo $row['name']; ?></td>
