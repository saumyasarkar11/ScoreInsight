...
<body class="login">
	...
	<form action="pass.php" method="POST" style="margin-top:20px;">
	    	<div class="login-form">
				<div class="form-group">
					<input type="email" id="email" name="email" placeholder="Enter your Registered Email" class="form-control" required="true">
					
				</div>
				
				<div class="form-action mb-3">
					<button type="submit" name="submit" class="btn btn-primary btn-login" style="padding:5px 5px 5px 5px;">Submit</button>
				</div>
					</form>
				  <?php
                     
                     if(isset($_SESSION['status2']) && $_SESSION['status2'] !=''){
                      echo '<p class="text-danger" align="center"> '.$_SESSION['status2']. '</p>';
                      unset($_SESSION['status2']);
                     }

                     ?>
				<div class="login-account">
					<small><span class="msg">&#169; 2020 Copyright | Powered By</span>
					<a href="https://techworth.in" target=_blank>Techworth</a></small>				</div>
			</div>
