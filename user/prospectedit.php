						...
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Edit Prospect&nbsp;&nbsp; <button style="padding: 5px 15px 5px 15px;" type="button" class="btn btn-primary btn-round " data-toggle="modal" data-target="#addcomment">Add Comment</button></div>
								</div>  
								<div class="card-body">
...
<tr><td><h6>GSTN: </td><td  class="number2a"  data-id2a="<?php echo $ida; ?>" ><?php echo $row_a['gstn']; ?></h6></td></tr>
...
<tr><td><h6>Website: </td><td class="number7a" data-id7a="<?php echo $ida; ?>" ><?php echo $row_a['website']; ?></h6></td></tr>
</tbody>
</table>
...
<tbody>
<tr><td><h6>Contact Name: </td><td class="number10" data-id10="<?php echo $row_a['company_id']; ?>" ><?php echo $row_a['contact_1']; ?></h6></td></tr>
...
<tr><td><h6>Staus: </td><td>
    ...
    ?>
  <select class="number18" data-id18="<?php echo $id; ?>" disabled>
      <option value="<?php echo $row['status']; ?>" selected hidden><?php echo $row['status']; ?></option>
    </select></h6></td></tr>
<tr><td><h6>Approx. Prospect Value: </td><td><input type="number" class="number19" data-id19="<?php echo $id; ?>" id="order" value="<?php echo $row['prospect_value']; ?>" disabled></h6></td></tr>
<tr><td><h6>Order Value: </td><td><input type="number" class="number20" data-id20="<?php echo $id; ?>" value="<?php echo $row['order_value']; ?>" disabled></h6></td></tr>
<tr><td><h6>Follow Up Date: </td><td><input type="text" id="datepicker" class="number21" data-id21="<?php echo $id; ?>" value="<?php echo $row['followup_date']; ?>" disabled></h6></td></tr>
<tr><td><h6>Closing Date: </td><td><input type="text" id="datepicker_1" class="number22" onchange="zero1()" data-id22="<?php echo $id; ?>" value="<?php echo $row['closing_date']; ?>" disabled></h6></td></tr>
      <?php
...
<tr><td><h6>Approx. Prospect Value: </td><td><input type="number" class="number19" data-id19="<?php echo $id; ?>" id="order" value="<?php echo $row['prospect_value']; ?>" ></h6></td></tr>
<tr><td><h6>Order Value: </td><td><input type="number" class="number20" data-id20="<?php echo $id; ?>" value="<?php echo $row['order_value']; ?>" ></h6></td></tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <textarea name="statement" class="form-control" placeholder="Enter Statement here" rows="5"></textarea>
      
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        <button  type="submit" class="btn btn-primary" name="addcomment">Save</button>
        </form>
      </div>
    </div>
  </div>
