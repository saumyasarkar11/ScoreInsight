...
<tr><td><h6>Requirement: </td><td><?php echo $row['requirement']; ?></h6></td></tr>
...
while ($row_k = mysqli_fetch_assoc($query_k)){
    ?>
<tr><td><h6><?php echo $row_k['statement']; ?></h6><small style="float:right;"><?php echo $row_k['time']; ?></small></td></tr> 
<?php
    }
?>
